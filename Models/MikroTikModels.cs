...
public class IpAddress
{
    ...
    [JsonIgnore] public string Network { get; set; } = "";
    [JsonProperty("interface")] public string Interface { get; set; } = "";
    [JsonProperty("disabled")] public bool Disabled { get; set; }
    [JsonIgnore] public bool Dynamic { get; set; }
    [JsonProperty("comment")] public string Comment { get; set; } = "";
}
...
// ---> ESTA É A CLASSE QUE TE ESTAVA A FALTAR
...
public class WireGuardPeer
{
    ...
    [JsonProperty("comment")] public string Comment { get; set; } = "";
    [JsonProperty("disabled")] public bool Disabled { get; set; }
    [JsonIgnore] public string Rx { get; set; } = "0";
    [JsonIgnore] public string Tx { get; set; } = "0";
}
...
public class SystemResource
{
    ...
    [JsonProperty("cpu-load")] public int CpuLoad { get; set; }
    [JsonProperty("free-memory")] public long FreeMemory { get; set; }
    [JsonProperty("total-memory")] public long TotalMemory { get; set; }
    [JsonProperty("board-name")] public string BoardName { get; set; } = "";
}

public class NatRule
{
    [JsonProperty(".id")] public string? Id { get; set; }
    [JsonProperty("chain")] public string Chain { get; set; } = "srcnat";
    [JsonProperty("action")] public string Action { get; set; } = "masquerade";
    [JsonProperty("src-address")] public string? SrcAddress { get; set; }
    [JsonProperty("dst-address")] public string? DstAddress { get; set; }
    [JsonProperty("comment")] public string Comment { get; set; } = "";
}